      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 justify-center mb-8">
            ...
            <span className="text-gold text-xs uppercase tracking-[0.3em] font-bold">Live Streaming</span>
          </div>
        ...
        <div className="mb-10">
          <div className="flex items-center gap-2 justify-center mb-8">
            ...
            <span className="text-gold text-xs uppercase tracking-[0.3em] font-bold">Publicité par zone</span>
          </div>
            ...
            {(Object.entries(AD_ZONE_PRICES) as [string, {label: string; price: number; description?: string}][]).map(([key, zone]) => {
              ...
              return (
                <div key={key} className="bg-luxury-dark border border-gold/10 rounded-xl p-6 text-center transition-all hover:border-gold/40">
                  ...
                  <ul className="text-left space-y-2 mb-6 text-sm">
                    <li className="flex items-center gap-2 text-gray-300"><Check size={14} className="text-gold shrink-0" /> Bannière {zone.label}</li>
                    {liveIncluded ? (
                      <li className="flex items-center gap-2 text-green-400"><Check size={14} className="text-green-400 shrink-0" /> Live inclus</li>
                    ) : (
